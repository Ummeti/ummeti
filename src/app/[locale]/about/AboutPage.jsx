...
export default function AboutPage({ stats, projectsCount }) {
        ...
        >
          ...
          <div className="w-full flex justify-center lg:justify-start gap-10">
            {[
              {
                number: `${
                  stats?.isAuto && projectsCount >= 0
                    ? projectsCount
                    : stats?.projects
                }+`,
                label: t('stats.projects'),
              },
              { number: `${stats?.supporters}+`, label: t('stats.supporters') },
              { number: `${stats?.served}+`, label: t('stats.peopleServed') },
            ].map((item, i) => (
              <motion.div
                key={i}
