export function ArFlagIcon() {
  return (
    <svg
      ...
      viewBox="0 0 512 512"
    >
      <mask id="circleFlagsPs0">
        <circle cx={256} cy={256} r={256} fill="#fff"></circle>
      </mask>
      <g mask="url(#circleFlagsPs0)">
        <path fill="#eee" d="M41.3 121.9L512 167v178L43.8 391.3z"></path>
        <path fill="#333" d="M0 0h512v167H111z"></path>
  ...
  return (
    ...
    >
      ...
      <g mask="url(#circleFlagsId0)">
        <path fill="#eee" d="m0 256l249.6-41.3L512 256v256H0z"></path>
        <path fill="#a2001d" d="M0 0h512v256H0z"></path>
      </g>
    </svg>
  );
}
